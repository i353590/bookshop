...
const _convertSelect = (cqn, model, ignoreSearch) => {
  ...
  if (!cqnSelectFromRef || (cqnSelectFromRef.length === 1 && !cqnSelectFromRef[0].where)) {
    if (cqnSelectFromRef && cqn.SELECT.search && !ignoreSearch) {
