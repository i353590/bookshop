...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c2 = function(p) { SELECT = { from:p } },
      peg$c3 = "?",
      ...
      peg$c14 = function(crv) {return {ref:[crv]}},
      peg$c15 = function(head, filter, p) {return p},
      peg$c16 = function(head, filter, tail) {
            const ref = [ filter ? { id:head, where:filter[1] } : head ]
            if (tail) {
            	const more = tail.ref, [{val}] = more
              if (val) ref[ref.length-1] = { id:ref[ref.length-1], where:[more.shift()] }
      		    ref.push (...more)
            }
            return {ref}
          },
      peg$c17 = function(val) {return [val]},
      peg$c18 = "=",
      peg$c19 = peg$literalExpectation("=", false),
      peg$c20 = function(ref, w) {return {val: w}},
      ...
      peg$c42 = function() { return {ref:'*'} },
      peg$c43 = function(col) {
            (SELECT.expand || (SELECT.expand = [])).push(col)
            return col
          },
      peg$c44 = function(c) {c.expand=[{ref: '*'}]},
      peg$c45 = function() {
              stack.push (SELECT)
      ...
      peg$c52 = function(p) {SELECT.search = p},
      peg$c53 = function(n) {return n?[n]:[]},
      peg$c54 = function(p, xpr) {p.push({xpr})},
      peg$c55 = function(p, val) {p.push({val})},
      peg$c56 = function(p, ao, more) {p.push(ao,...more)},
      peg$c57 = function(p) {return p},
      peg$c58 = function(p) {SELECT.where = p},
      peg$c59 = function(p, comp) {p.push(...comp)},
      peg$c60 = function(p, lambda) {p.push(...lambda)},
      peg$c61 = function(p, func) {p.push(func)},
      peg$c62 = function(n) {return[n]},
      peg$c63 = function(nav, n) {nav.push(n)},
      peg$c64 = function(nav, any) {
              if (!any) return []
              let id = nav.pop(), xpr = []
      ...
      peg$c65 = function(nav, all) {
              let id = nav.pop()
              return ['not', 'exists', { ref: [...nav, { id, where: ['not', { xpr: [...all] }] }] }]
            },
      peg$c66 = function(nav, xpr) { return xpr },
      peg$c67 = function(n) { return n ? [n] : [] },
      peg$c68 = function(p, xpr) { p.push('(', ...xpr, ')') },
      peg$c69 = function(p, comp) { p.push(...comp) },
      peg$c70 = function(p, ao, more) { p.push(ao, ...more) },
      peg$c71 = function(p) { return p },
      peg$c72 = ":",
      peg$c73 = peg$literalExpectation(":", false),
      peg$c74 = function(prefix, inner) {
      ...
      peg$c75 = "any",
      peg$c76 = peg$literalExpectation("any", false),
      peg$c77 = "all",
      peg$c78 = peg$literalExpectation("all", false),
      peg$c79 = "asc",
      peg$c80 = peg$literalExpectation("asc", false),
      peg$c81 = "desc",
      peg$c82 = peg$literalExpectation("desc", false),
      peg$c83 = function(ref, s) {return s},
      peg$c84 = function(ref, sort) {
      ...
      peg$c89 = function(val) { if(val === 'true') { SELECT.count = true } },
      peg$c90 = /^[a-zA-Z]/,
      ...
      peg$c96 = peg$otherExpectation("a comparison"),
      peg$c97 = "eq",
      peg$c98 = peg$literalExpectation("eq", false),
      peg$c99 = "ne",
      peg$c100 = peg$literalExpectation("ne", false),
      peg$c101 = "lt",
      peg$c102 = peg$literalExpectation("lt", false),
      peg$c103 = "gt",
      peg$c104 = peg$literalExpectation("gt", false),
      peg$c105 = "le",
      peg$c106 = peg$literalExpectation("le", false),
      peg$c107 = "ge",
      peg$c108 = peg$literalExpectation("ge", false),
      peg$c109 = function(a, o, b) {
      ...
      peg$c112 = "sub",
      peg$c113 = peg$literalExpectation("sub", false),
      peg$c114 = "mul",
      peg$c115 = peg$literalExpectation("mul", false),
      peg$c116 = "div",
      peg$c117 = peg$literalExpectation("div", false),
      peg$c118 = "mod",
      peg$c119 = peg$literalExpectation("mod", false),
      peg$c120 = peg$otherExpectation("an operand"),
      peg$c121 = function(bool) { return {val: bool === 'true'}},
      peg$c122 = peg$otherExpectation("a reference"),
      peg$c123 = function(head, n) {return n},
      ...
      peg$c126 = function(val) {return typeof val === 'number' ? {val} : { val, literal:'number' }},
      peg$c127 = "[",
      ...
      peg$c133 = function(any) { return { list: any.replace(/"/g,'').split(',').map(ele => ({ val: ele })) } },
      peg$c134 = peg$otherExpectation("a function call"),
      peg$c135 = /^[a-z]/,
      peg$c136 = peg$classExpectation([["a", "z"]], false, false),
      peg$c137 = function(func, a, o) {return o},
      peg$c138 = function(func, a, more) {
      ...
      peg$c139 = peg$otherExpectation("a boolean function"),
      peg$c140 = "contains",
      peg$c141 = peg$literalExpectation("contains", false),
      peg$c142 = "endswith",
      peg$c143 = peg$literalExpectation("endswith", false),
      peg$c144 = "startswith",
      peg$c145 = peg$literalExpectation("startswith", false),
      peg$c146 = function(func, a, b) { return { func, args:[a,b] }},
      peg$c147 = "not",
      peg$c148 = peg$literalExpectation("NOT", true),
      peg$c149 = function() {return 'not'},
      peg$c150 = "and",
      peg$c151 = peg$literalExpectation("AND", true),
      peg$c152 = function() {return 'and'},
      peg$c153 = "or",
      peg$c154 = peg$literalExpectation("OR", true),
      peg$c155 = function() {return 'or'},
      peg$c156 = "aggregate",
      peg$c157 = peg$literalExpectation("aggregate", false),
      peg$c158 = "groupby",
      peg$c159 = peg$literalExpectation("groupby", false),
      peg$c160 = "filter",
      peg$c161 = peg$literalExpectation("filter", false),
      peg$c162 = "expand",
      peg$c163 = peg$literalExpectation("expand", false),
      peg$c164 = "search",
      peg$c165 = peg$literalExpectation("search", false),
      peg$c166 = "concat",
      peg$c167 = peg$literalExpectation("concat", false),
      peg$c168 = "compute",
      peg$c169 = peg$literalExpectation("compute", false),
      peg$c170 = "bottompercent",
      peg$c171 = peg$literalExpectation("bottompercent", false),
      peg$c172 = "bottomsum",
      peg$c173 = peg$literalExpectation("bottomsum", false),
      peg$c174 = "toppercent",
      peg$c175 = peg$literalExpectation("toppercent", false),
      peg$c176 = "topsum",
      peg$c177 = peg$literalExpectation("topsum", false),
      peg$c178 = function(alias) { return { func: 'count', args: ['*'], as: alias } },
      peg$c179 = function(res) { (SELECT.expand || (SELECT.expand = [])).push(res) },
      peg$c180 = function(path, func, alias) { return { func, args: [ path ], as: alias } },
      peg$c181 = "with",
      peg$c182 = peg$literalExpectation("with", false),
      peg$c183 = function(func) { return func; },
      peg$c184 = "from",
      peg$c185 = peg$literalExpectation("from", false),
      peg$c186 = "as",
      peg$c187 = peg$literalExpectation("as", false),
      peg$c188 = function(alias) { return alias; },
      peg$c189 = function(val) { (SELECT.groupBy || (SELECT.groupBy = [])).push(val) },
      peg$c190 = "rollup",
      peg$c191 = peg$literalExpectation("rollup", false),
      peg$c192 = "$all",
      peg$c193 = peg$literalExpectation("$all", false),
      peg$c194 = "topcount",
      peg$c195 = peg$literalExpectation("topcount", false),
      peg$c196 = "bottomcount",
      peg$c197 = peg$literalExpectation("bottomcount", false),
      peg$c198 = function(trafo, val, ref) {
            const oredrObj = { ...ref, sort: trafo === 'topcount' ? 'desc' : 'asc' };
            SELECT.orderBy = SELECT.orderBy ? [...SELECT.orderBy, oredrObj] : [oredrObj];
            (SELECT.limit || (SELECT.limit={})).rows = {val};
          },
      peg$c199 = "identity",
      peg$c200 = peg$literalExpectation("identity", false),
      peg$c201 = peg$otherExpectation("Edm.String"),
      peg$c202 = "'",
      peg$c203 = peg$literalExpectation("'", false),
      peg$c204 = "''",
      peg$c205 = peg$literalExpectation("''", false),
      peg$c206 = /^[^']/,
      peg$c207 = peg$classExpectation(["'"], true, false),
      peg$c208 = function(s) {return s.replace(/''/g,"'")},
      peg$c209 = /^[+"-"a-zA-Z0-9"."]/,
      peg$c210 = peg$classExpectation(["+", ["\"", "\""], ["a", "z"], ["A", "Z"], ["0", "9"], "\"", ".", "\""], false, false),
      peg$c211 = /^[0-9]/,
      ...
      peg$c219 = "Z",
      peg$c220 = peg$literalExpectation("Z", false),
      peg$c221 = "+",
      ...
      peg$c227 = function(s) {return safeNumber(s)},
      peg$c228 = function(s) {return parseInt(s)},
      peg$c229 = /^[_a-zA-Z0-9"."]/,
      peg$c230 = peg$classExpectation(["_", ["a", "z"], ["A", "Z"], ["0", "9"], "\"", ".", "\""], false, false),
      peg$c231 = /^[0-9a-zA-Z]/,
      peg$c232 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"]], false, false),
      peg$c233 = function(val) {return {val} },
      peg$c234 = ",",
      ...
      peg$c240 = peg$otherExpectation("optional whitespaces"),
      peg$c241 = /^[ \t\n]/,
      peg$c242 = peg$classExpectation([" ", "\t", "\n"], false, false),
      peg$c243 = peg$otherExpectation("mandatory whitespaces"),
