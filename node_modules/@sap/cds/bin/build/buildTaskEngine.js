...
class BuildTaskEngine {
    ...
    _logTaskHandler(handler) {
        ...
        this.logger.log(`[cds] - details src [${relativePaths(handler.buildOptions.root, handler.task.src)}], dest [${relativePaths(handler.buildOptions.root, handler.task.dest)}], use [${handler.task.use}], options [${JSON.stringify(handler.task.options)}]`) //NOSONAR
    }
