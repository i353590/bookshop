...
const { BUILD_OPTION_OUTPUT_MODE, OUTPUT_MODE_DEFAULT, OUTPUT_MODE_RESULT_ONLY, SEVERITY_INFO, SEVERITY_WARNING, SEVERITY_ERROR } = require('./constants')
const { hasOptionValue, getProperty, relativePaths, isAbsolutePath, BuildMessage } = require('./util')
const OVERRIDE_METHOD_MSG = "Must override method"
...
class BuildTaskHandler {
    ...
    /**
     * Sets the build task executed by this build task handler.
     * @param {object} task
     */
    set task(task) {
